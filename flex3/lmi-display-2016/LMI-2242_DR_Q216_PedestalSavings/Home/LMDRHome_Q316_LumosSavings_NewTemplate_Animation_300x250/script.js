...
function startAnimation(){
  ...
  // TweenMax.to("#sol", 1, {delay: 1, scale:0.35, x:"+=137", y:"+=8", transformOrigin:"right", ease: Linear.easeNone});
  ...
  TweenMax.to("#text", .4, {delay: 2, left:1, top:1, transformOrigin:"right", ease: Linear.easeNone});
  TweenMax.to("#cta", .4, {delay: 2, left:32, top:185, transformOrigin:"right", ease: Linear.easeNone,  onComplete:addListeners});
...
function ctaRollOverHandler(){
  ...
  TweenMax.fromTo(".glare", 1, {css: {left: -55}}, {css:{left:355}, ease:Linear.easeNone} );
}
