...
function startAnimation(){
  ...
  // TweenMax.to("#sol", .75, {delay: 1, scale:.15, x:"+=20", y:"+=95", transformOrigin:"right", ease: Linear.easeNone});
  TweenMax.to("#sol", .75, {delay: 1, scale:.15, x:"+=40", y:"+=105", transformOrigin:"right", ease: Linear.easeNone});
  TweenMax.to("#text", .25, {delay: 2, left:-12, top:1, transformOrigin:"right", ease: Linear.easeNone, onComplete:addListeners});
