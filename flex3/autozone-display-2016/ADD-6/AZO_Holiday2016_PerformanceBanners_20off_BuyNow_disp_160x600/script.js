...
startAnimation = function() {
  ...
  tl.from('#txt1', .65, { x: -175, ease: easeIn })
  tl.to('#txt1',   .65, { delay: 1.75, x: 175,  ease: easeOut })

  tl.from('#txt2', .65, { x: -175, ease: easeIn })
  tl.to('#txt2',   .65, { delay: 1.75, x: 175,  ease: easeOut })

  tl.add('cta');
  tl.from('#cta_txt', .65, { x: -175, ease: easeIn }, 'cta');
