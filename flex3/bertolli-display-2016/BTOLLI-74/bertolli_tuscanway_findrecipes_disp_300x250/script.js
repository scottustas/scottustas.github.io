...
function startAnimation(){
  ...
  TweenMax.to("#jar", .75, {delay:1, left:4});
  TweenMax.from("#text1", .75, {delay:1.25, alpha:0});

  TweenMax.to("#jar", .5, {delay:3.5, alpha:0});
  ...
  TweenMax.to("#jar", .5, {delay:14.25, alpha:1});

  TweenMax.from("#cta", .25, {delay:14.5, scale:0, ease:Back.easeOut, onComplete:endFrame});
  TweenMax.to("#glare", .5, {delay:14.75, left:125});
...
function ctaRollOverHandler(){
  ...
  if (endFrameReached) TweenMax.fromTo("#glare", .5, {css: {left: -120}}, {css:{left:125}} );
}
