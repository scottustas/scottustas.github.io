...
function timerEventListener(e)
{
  switch (timerCount)
  {
    ...
    case .5:
      ...
      TweenMax.to([items.football, items.footballBlurred], 1.5, {ease: Expo.easeOut, left: 285});
      TweenMax.to(items.footballBlurred, 1.5, {autoAlpha:0, ease: Quint.easeOut});
      TweenMax.to(items.text1, .25, {delay: .15, clip:"rect(0px, 460px, 61px, 0px)", ease:Linear.easeInOut});
    ...
    case 3.5:
      ...
      TweenMax.from(items.text2, .5, {left: "+=200", ease: Expo.easeOut});
      TweenMax.to(items.text2, .5, {alpha: 1});
